...
//        self.addGestureRecognizer(panGesture)
        ...
        lblHeader.font = UIFont(name: FontName.TimesNewRomanBoldItalic, size: 20)
        ...
        lblMessage.font = UIFont(name: FontName.TimesNewRomanItalic, size: 18)
...
//MARK: - Show Popup
    func show(complete : ((Int)->())? , view: UIView,animationType: NSString,strMessage: String,btnArray: NSArray,strTitle: String = "")
    {
        ...
        for strBtnTitle in btnArray
        {
            ...
            lblButtonNameDummy.font = UIFont(name: FontName.TimesNewRomanBoldItalic, size: 20)
            ...
            btnOk.titleLabel?.font = UIFont(name: FontName.TimesNewRomanBoldItalic, size: 20)
...
//MARK: - Tapped On Button
    ...
    {
//        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "okTapped"), object: nil)
        print("Tapped On Ok")
...
struct FontName
{
    ...
    static let TimesNewRomanBoldItalic = "TimesNewRomanPS-BoldItalicMT"
    static let TimesNewRomanItalic = "TimesNewRomanPS-ItalicMT"
}
//MARK: - Animation
struct MTAnimation {
